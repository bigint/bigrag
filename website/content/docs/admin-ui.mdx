...
| `/collections/[name]/connectors/s3` | Add S3/R2 bucket-prefix sources, monitor sync progress, trigger manual resync, and manage sync schedules. Source creation and manual sync are disabled when the worker is offline. |
