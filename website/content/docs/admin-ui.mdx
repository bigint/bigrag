...
**S3/R2:** The S3 connector page subscribes to `admin.connectors.sources` and `admin.connectors.sync_jobs` for the selected collection. The sync monitor shows object scanning, concurrent download/update progress, remote deletion cleanup, and queued-for-ingestion completion; document conversion and indexing continue through the normal document progress surfaces.
