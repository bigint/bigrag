...
| `/settings` | Operator-console settings workspace for account, platform health, security, data flow, ingestion staging, vector storage, and backups. |
