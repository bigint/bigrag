...
- Redis holds the ingestion queue, the event bus, idempotency responses, and short-lived platform caches — all ephemeral, but queue payloads can contain document IDs and user context.
