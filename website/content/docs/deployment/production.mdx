...
- [ ] Backup strategy: daily `pg_dump` + Qdrant backup tool + S3
...
python -m bigrag.main --log-level debug --log-format text

# Production (structured JSON)
python -m bigrag.main --log-level info --log-format json
```
