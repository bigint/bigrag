...
| `document:upload` | Upload documents, batch upload, and reprocess |
| `document:read` | List / get / download documents, chunks, batch get/status, and global `/v1/documents/{id}` lookups |
