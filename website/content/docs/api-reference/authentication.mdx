...
The Studio UI exposes the same flow at `http://localhost:3000/setup`.
...
curl "http://localhost:4000/v1/collections/docs/events?token=bigrag_sk_…"
```
</Tab>
</Tabs>
...
| `/v1/collections`, `/v1/collections/**` (incl. `s3-jobs`), `/v1/query`, `/v1/batch/query`, `/v1/stats`, `/v1/embeddings/models` | ✓ | ✓ | — |
| `/v1/admin/api-keys`, `/v1/admin/users`, `/v1/admin/audit`, `/v1/admin/webhooks`, `/v1/admin/embedding-presets`, `/v1/auth/preferences` | ✓ | — | — |
