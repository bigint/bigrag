...
Returns the collection marked as the default.

**Response** `200`: Full collection object.

**Errors:** `404` — No default collection set
...
| `is_default` | boolean | no | `false` | Mark as default collection |
| `metadata` | object | no | `{}` | Arbitrary key-value pairs |

Setting `is_default: true` clears the flag on any previously default collection.
...
| `is_default` | boolean | no | Mark as default collection |

Setting `is_default: true` clears the flag on any other collection.
