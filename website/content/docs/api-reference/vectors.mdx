...
For advanced use cases, you can directly manage Turbopuffer vectors without going through the document ingestion pipeline. This is useful for custom embeddings or integrating with external embedding services.
