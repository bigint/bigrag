...
The client follows a Stripe-style **resource namespace** layout: `client.collections`, `client.documents`, `client.chat`, `client.queries`, `client.vectors`, `client.webhooks`.
