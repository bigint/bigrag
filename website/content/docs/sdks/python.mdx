...
`typing-extensions` on Python versions earlier than 3.11. Published SDK releases
use CalVer (`YYYY.M.D`).
...
| `client.admin` | Users, API keys, audit logs, embedding presets, and MCP server keys |
