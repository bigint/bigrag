...
A **collection** is a logical grouping of documents that share the same embedding configuration. Each collection maps to one backend object in the configured vector store.
