---
title: Documents
description: How rag.computer ingests, parses, chunks, and embeds documents for vector search.
---
...
rag.computer extracts embedded text from PDFs directly, and uses [Docling](https://github.com/DS4SD/docling) for other rich document parsing:
