...
Ingest files directly from an S3 bucket (or S3-compatible services like MinIO). Provide a bucket name and optional prefix to filter objects — all supported file types are ingested automatically and unsupported files are skipped.
...
const eventSource = new EventSource(
  "http://localhost:4000/v1/collections/research/documents/DOC_ID/progress"
);
