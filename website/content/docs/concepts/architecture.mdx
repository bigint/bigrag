...
Client → FastAPI
  ...
  │ 3. Qdrant search (with payload filters)
  │ 4. optional hybrid fusion — keyword search + reciprocal rank fusion
...
local OCR for scanned PDFs is opt-in with `BIGRAG_CONVERSION_PDF_OCR_ENABLED=true`.
