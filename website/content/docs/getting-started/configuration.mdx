...
| Ingestion | Upload limits, OCR toggle, Docling timeout, ingestion workers, vector batch size. |
...
| Retention | Query log, access log, webhook delivery, progress snapshot, and audit retention windows. |
