...
Database-backed admin settings apply immediately on save or reset. Storage and vector-store changes validate the new target before saving, then swap the active backend in place.
