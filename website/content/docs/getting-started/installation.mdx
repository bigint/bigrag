...
<Callout type="info">
  Interactive Swagger docs are available at [http://localhost:6100/docs](http://localhost:6100/docs) once the server is running. Database migrations run automatically on startup.
</Callout>
