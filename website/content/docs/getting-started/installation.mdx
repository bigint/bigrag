---
title: Installation
description: Install and run rag.computer using Docker Compose or from source.
---
...
- **rag.computer API** on port `4000` (Swagger docs at `/docs`)
