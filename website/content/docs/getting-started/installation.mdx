...
Release artifacts use CalVer (`YYYY.M.D`). Docker publishes `latest` for convenience, but production deployments should pin the dated tag from the release they deploy.
