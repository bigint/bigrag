...
The response sets a `bigrag_session` cookie. The Studio UI exposes the same flow at `http://localhost:3100/setup`.
</Step>
...
- Open the [Studio UI](/docs/studio) at `http://localhost:3100` for a visual view of collections, documents, and query analytics.
