...
- **Operational features** — batch ingestion, webhooks with HMAC signatures, metadata-schema validation, an evaluation runner, and per-collection query analytics
- **Admin UI** — first-run setup, collection browser, query playground, API-key minter, webhook manager
