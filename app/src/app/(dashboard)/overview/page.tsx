      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>
                The last five collections you created or updated.
              </CardDescription>
            </div>
            <Link
              href="/collections"
          ...
          <CardContent className="p-0">
            {!collections ? (
              ...
              <div className="px-5 pb-6 text-sm text-[var(--color-muted-foreground)]">
                No collections yet.{" "}
                <Link href="/collections" className="text-[var(--color-primary)] hover:underline">
                  Create your first →
                </Link>
              </div>
            ) : (
                ...
                {collections.collections.slice(0, 5).map((c) => (
                  <li key={c.id}>
                    <Link
                      ...
                      className="flex items-center justify-between gap-3 px-5 py-3 hover:bg-[var(--color-muted)]"
                    >
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-2">
            ...
            <HealthRow label="Embeddings" ok={readiness?.embedding} detail={readiness?.embedding_error} />
            {readiness?.version && (
...
const QuickLink = ({
  ...
  <Link
    href={href}
    className="group rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] p-4 transition-colors hover:border-[var(--color-primary)] hover:bg-[var(--color-accent)]"
  >
    <div className="flex items-start gap-3">
      <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[var(--color-accent)] text-[var(--color-accent-foreground)] group-hover:bg-[var(--color-primary)] group-hover:text-[var(--color-primary-foreground)]">
