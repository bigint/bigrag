...
export const ConnectorsPage = () => {
  ...
  return (
    <div className="flex flex-col gap-5">
      <PageHeader
        className="mb-0"
        description="Configure OAuth provider credentials and account state for external source connectors."
        title="Connectors"
      />
          ...
          <div className="flex flex-col gap-5 p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Save OAuth credentials first, copy the callback URL into Google Cloud, then connect
                a user account from a collection's Drive browser.
              </p>
            </div>
