...
_ENDPOINT_SCOPES: list[tuple[str, str, str]] = [
    ...
    ("POST", "/v1/collections/{name}/vectors/upsert", "collection:write"),
    ("POST", "/v1/collections/{name}/vectors/delete", "collection:write"),
    ("GET", "/v1/collections/{name}/analytics", "collection:read"),
    ("GET", "/v1/collections/{name}/s3-jobs", "collection:read"),
    ("PATCH", "/v1/collections/{name}/s3-jobs/{job_id}", "collection:write"),
    ("POST", "/v1/collections/{name}/s3-jobs/{job_id}/resync", "collection:write"),
    ("DELETE", "/v1/collections/{name}/s3-jobs/{job_id}", "collection:delete"),
