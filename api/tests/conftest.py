...
async def client(mock_db, mock_vector_store, mock_queue, mock_storage, mock_webhook_dispatcher):
    ...
    with contextlib.ExitStack() as stack:
        ...
        stack.enter_context(patch("bigrag.routers.webhooks.webhook_dispatcher", mock_webhook_dispatcher))
        ...
        stack.enter_context(patch("bigrag.routers.webhooks.generate_secret", return_value="whsec_test123"))
