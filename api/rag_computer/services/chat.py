...
from rag_computer.db.models import ChatConversation, ChatMessage, Document, UserPreference
from rag_computer.exceptions import NotFoundError, ServerError, UpstreamError, ValidationError
from rag_computer.logging import get_logger
from rag_computer.models.chat import (
...
from rag_computer.routers.preferences import decrypt_preferences
...
from rag_computer.services.tenant_enforcement import require_tenant_filters
from rag_computer.services.url_security import UnsafeOutboundUrlError, validate_chat_base_url

logger = get_logger("rag_computer.chat")
...
def _append_credential(
    ...
    if api_key.startswith(crypto._FERNET_PREFIX):
        raise ServerError(f"{source} cannot be decrypted. Configure RAG_COMPUTER_MASTER_KEY.")
