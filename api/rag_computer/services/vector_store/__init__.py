...
from rag_computer.services._retrieval_filters import FilterExpression
from rag_computer.services.vector_store.base import (
    VectorStoreBackend,
    VectorStoreFeatureError,
    VectorStoreProvider,
)
from rag_computer.services.vector_store.qdrant import QdrantVectorStore, _to_qdrant_filter
from rag_computer.services.vector_store.s3_vectors import S3VectorsStore, _to_s3_filter
from rag_computer.services.vector_store.turbopuffer import (
...
class VectorStore:
    ...
    def configure(
        ...
        *,
        ...
        s3_vectors_index_prefix: str = "rag_computer_",
        ...
        turbopuffer_namespace_prefix: str = "rag_computer_",
    ) -> None:
