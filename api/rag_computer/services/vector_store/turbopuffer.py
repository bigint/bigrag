...
from rag_computer.services._retrieval_filters import FilterCondition, FilterExpression
...
logger = get_logger("rag_computer.vector_store")
...
class TurbopufferVectorStore:
    ...
    def __init__(
        ...
        *,
        api_key: str | None,
        region: str,
        namespace_prefix: str = "rag_computer_",
    ) -> None:
        self.api_key = api_key
        self.region = region
        self.prefix = namespace_prefix or "rag_computer_"
