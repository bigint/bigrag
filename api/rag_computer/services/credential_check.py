...
from rag_computer.services.url_security import UnsafeOutboundUrlError, validate_embedding_base_url

logger = get_logger("rag_computer.services.credential_check")
