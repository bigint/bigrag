...
from rag_computer.services.embedding import EmbeddingModel
from rag_computer.services.event_bus import IngestionEvent, event_bus
from rag_computer.services.runtime_settings import get_value, get_values
from rag_computer.services.vector_store import VectorStoreFeatureError, vector_store
from rag_computer.utils import safe_create_task

logger = get_logger("rag_computer.retrieval")

_QUERY_EPOCH_PREFIX = "rag-computer:query_epoch:"
...
async def _log_query(
    ...
    try:
        ...
        from rag_computer.db.models import Collection, QueryLog
