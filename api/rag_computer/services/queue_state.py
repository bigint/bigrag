...
logger = get_logger("rag_computer.queue")

QUEUE_KEY = "rag-computer:ingestion:queue"
PROCESSING_KEY = "rag-computer:ingestion:processing"
DEAD_LETTER_KEY = "rag-computer:ingestion:dead"
STATS_KEY = "rag-computer:ingestion:stats"
LEASE_KEY_PREFIX = "rag-computer:ingestion:lease:"
COLLECTION_EPOCH_KEY_PREFIX = "rag-computer:ingestion:collection_epoch:"
DOCUMENT_EPOCH_KEY_PREFIX = "rag-computer:ingestion:document_epoch:"
