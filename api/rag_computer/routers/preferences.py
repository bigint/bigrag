...
from rag_computer.db.models import UserPreference
...
from rag_computer.services.credential_check import CredentialCheckError, verify_provider_credentials

logger = get_logger("rag_computer.routers.preferences")
