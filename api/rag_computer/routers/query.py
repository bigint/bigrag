...
from rag_computer.services.embedding import AVAILABLE_MODELS
from rag_computer.services.retrieval import (
...
logger = get_logger("rag_computer.routers.query")
...
async def collection_analytics(
    ...
    from rag_computer.db.models import QueryLog
