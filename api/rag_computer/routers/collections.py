...
from rag_computer.db.models import Collection, Document, EmbeddingPreset
...
from rag_computer.models.collection import (
...
from rag_computer.services.event_tokens import (
...
logger = get_logger("rag_computer.routers.collections")
...
async def create_collection(
    ...
    try:
        from rag_computer.services.embedding import get_embedding_model
