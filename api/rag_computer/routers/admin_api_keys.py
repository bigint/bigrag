...
from rag_computer.db.models import ApiKey, Collection
from rag_computer.db.session import get_session
from rag_computer.logging import get_logger
from rag_computer.middleware.auth import invalidate_api_key_principal, require_admin_session
from rag_computer.models.auth import (
    ApiKeyListResponse,
    ApiKeyResponse,
    CreateApiKeyRequest,
...
from rag_computer.services.auth import generate_api_key

logger = get_logger("rag_computer.routers.admin_api_keys")
...
def _validate_scopes(scopes: list[str] | None) -> None:
    if not scopes:
        return
    from rag_computer.services.scopes import validate_scope_string
