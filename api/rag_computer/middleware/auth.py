...
from rag_computer.db.models import ApiKey, User
from rag_computer.db.models import Session as DbSession
...
from rag_computer.services.auth import API_KEY_PREFIX, hash_api_key, hash_session_token

logger = get_logger("rag_computer.auth")
...
async def _touch_api_key_last_used(
    ...
    *,
    ...
    if redis is not None:
        throttle_key = f"rag-computer:auth:api_key_touch:{api_key_id}"
...
async def get_current_user(
    ...
    from rag_computer.services.collection_scope import enforce_collection_scope
    from rag_computer.services.scopes import has_scope, required_scope
