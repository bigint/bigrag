...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("source_type IN ('prefix')", name="connector_sources_source_type_check"),
        sa.CheckConstraint(
    ...
    op.create_table(
        ...
        sa.Column("access_key_id", bigrag.services.crypto.EncryptedString(), nullable=False),
        sa.Column("secret_access_key", bigrag.services.crypto.EncryptedString(), nullable=False),
        sa.Column("session_token", bigrag.services.crypto.EncryptedString(), nullable=True),
        sa.Column("region", sa.Text(), server_default="us-east-1", nullable=False),
        sa.Column("endpoint_url", sa.Text(), nullable=True),
        sa.Column(
            "force_path_style", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "idx_connector_source_credentials_source_id",
        "connector_source_credentials",
        ["source_id"],
        unique=False,
    )
