"""Low-level HTTP transport for the rag.computer API."""
...
USER_AGENT = f"rag-computer-python/{__version__}"
...
class RagComputerCore:
    """Low-level async HTTP transport with retry, auth, and error handling.

    This class is not usually instantiated directly.  Use :class:`RagComputer`
    ...
    def __init__(
        ...
        *,
        ...
        self.api_key = (
            ...
            else (os.environ.get("RAG_COMPUTER_API_KEY") or "")
        )
    ...
    async def __aenter__(self) -> RagComputerCore:
        return self
