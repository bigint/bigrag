"""Error hierarchy for the rag.computer Python SDK."""

from __future__ import annotations


class RagComputerError(Exception):
    """Base exception for all rag.computer SDK errors."""


class APIError(RagComputerError):
    """An error response from the rag.computer API."""
...
class APIConnectionError(RagComputerError):
...
class APITimeoutError(RagComputerError):
