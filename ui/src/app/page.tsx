    ...
    <div className="min-h-screen text-text">
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard label="Namespaces" isLoading={isLoading}>
            {formatNumber(allNames.length)}
          </StatCard>
          <StatCard label="Documents" isLoading={isLoading}>
            {formatNumber(totalDocs)}
          </StatCard>
          <StatCard label="Storage" isLoading={isLoading}>
            {formatBytes(totalStorage)}
          </StatCard>
          <StatCard label="Server" isLoading={isLoading}>
