...
import { healthQueryOptions, adminConfigQueryOptions } from '@/lib/queries'
    ...
    <div className="text-text">
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <div className="rounded-lg border border-border bg-bg-card">
            <div className="divide-y divide-border">
              <SettingsRow label="API URL" isLoading={isLoading}>
                <span className="font-mono text-sm text-text">{apiUrl}</span>
              </SettingsRow>

              <SettingsRow label="Status" isLoading={isLoading}>
              ...
              <SettingsRow label="Version" isLoading={isLoading}>
        ...
        <div>
          ...
          <div className="rounded-lg border border-border bg-bg-card">
            <div className="divide-y divide-border">
              <SettingsRow label="Product" isLoading={false}>
                <span className="text-sm font-medium text-text">bigRAG</span>
              </SettingsRow>
              <SettingsRow label="Version" isLoading={false}>
                <span className="font-mono text-sm text-text">
                  {version || '---'}
                </span>
              </SettingsRow>
              <SettingsRow label="License" isLoading={false}>
